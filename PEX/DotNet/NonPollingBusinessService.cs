...
namespace InterSystems.Demo.PEX
{
    class NonPollingBusinessService
    {
        static void Main(string[] args)
        {
            try
            {
                IRISADOConnection connection = InterSystems.Data.IRISClient.Gateway.Gateway.GetConnection("Server=localhost; Port=51777; Namespace=Ensemble; Password=SYS; User ID=_SYSTEM; SharedMemory=false");
